...
export const metadata: Metadata = { title: "Terms · Weektable", description: "Terms for the Weektable internal beta." };

export default function TermsPage() {
  return <main className="legal-page"><article className="legal-page__inner">
    <Link href="/">← Weektable</Link><p className="landing-eyebrow">Terms</p><h1>Internal beta terms</h1>
    ...
    <h2>Planning estimates</h2><p>Weektable provides meal-planning information, estimated nutrition, and estimated complete-package catalog prices. It does not provide medical, dietary, or financial advice. Prices, package sizes, availability, nutrition, and labels can change; verify them before purchasing or eating a product.</p>
    <h2>Allergies and food safety</h2><p>Weektable applies selected allergies as hard constraints using available recipe and catalog metadata. You remain responsible for checking labels, preparation conditions, recalls, and cross-contact warnings. Weektable cannot guarantee allergen-free products or kitchens.</p>
