...
export const metadata: Metadata = { title: "Privacy · Cove", description: "How Cove processes planner and grocery data during the internal beta." };

export default function PrivacyPage() {
  return <main className="legal-page"><article className="legal-page__inner">
    <Link href="/">← Cove</Link><p className="landing-eyebrow">Privacy</p><h1>Cove privacy notice</h1>
    ...
    <h2>Advertising and sale</h2><p>Cove does not use beta planner data for advertising and does not sell it. Do not put unnecessary sensitive or identifying information into custom instructions.</p>
